...
INSERT INTO public."Session"("session_id", "name", "start_at", "end_at", "summarization", "Session_PresentedBy_User")
 VALUES
 (4, 'A Scala 3 update', '2021-10-01T21:00:00.105Z', '2021-10-01T22:00:00.105Z', 'Martin will report on recent progress and the current state of Scala 3. In this talk, Martin also will lay out the next steps of the planned transition and how the community can help in implementing them.', 201),
 (5, 'From Numpy to PyTorch API Compatibility', '2021-10-01T22:00:00.105Z', '2021-10-01T22:30:00.105Z', 'NumPy has grown to be a vital part of the data science workflow for everyone from astrophysicists to zoologists. This talk is about how PyTorch approaches being “NumPy-compatible,” and why the PyTorch community thinks that’s important, why it can be challenging, and why sometimes it’s necessary to be divergent from NumPy’s behavior', 202),
 (6, 'Writing Good Docs for Developers', '2021-10-01T22:30:00.105Z', '2021-10-01T23:00:00.105Z', 'If you are building something for developers, you want it to get used. This means your potential users need to find your library, framework, or API. They need to work out whether it is useful for them, learn how to use it, and solve problems they encounter along the way. All these things depend on your developer docs!', 203),
 (7, 'Data Processing on Ray', '2021-10-01T23:00:00.105Z', '2021-10-01T23:30:00.105Z', 'Machine learning and data processing applications continue to drive the need to develop scalable Python applications. Ray is a distributed execution engine that enables programmers to scale up their Python applications. This talk will cover some of the challenges we faced and key architectural changes we made to Ray over the past year to support a new set of large scale data processing workloads.', 204),
 (8, 'Magic: How Python inserts "self" into methods', '2021-10-01T23:30:00.105Z', '2021-10-02T01:00:00.105Z', 'In this talk, I want to entice you to look beyond the Python high-level interface into the wonderful landscape of its data model. I will do that by explaining one of Python most magical features: The automatic insertion of self into methods. Often, to beginners, the insertion of the instance as the first argument to methods is explained as something that Python just does for you: Don not worry about it, it just happens!.', 205),
 (9, 'Modern Forms in React', '2021-10-02T01:00:00.105Z', '2021-10-02T01:30:00.105Z', 'If the new React Context API and Suspense killed Redux (they didn not), surely Hooks kill the need for a form library, right? Well, not exactly. Managing form state is more than just holding your current values in state; it is about sync and async validation errors, and much more! But that does not mean that Hooks are irrelevant to the situation. Hooks make building forms in React easier than ever before.', 206),
 (10, 'Building with Monorepos', '2021-10-02T01:30:00.105Z', '2021-10-02T02:00:00.105Z', 'Monorepos are everywhere in the React community from design systems and apps to open source libraries. Being able to work on multiple packages together is powerful, but it is not without its problems. Lets learn how to solve these problems by exploring the evolution of Emotions monorepo. If you are not familiar with monorepos, don not worry. Mitchell will cover what they are, when and why you would want to use one and how to get started with them!', 207),
 (11, 'The Value of Open Source', '2021-10-02T02:00:00.105Z', '2021-10-02T02:30:00.105Z', 'Jed wraps up ReactConf AU by discussing the sustainability of open source, the value OSS creates for us all individually and as a collective, and then proposes some small steps we can all take to ensure the future of our vibrant community.', 208);
